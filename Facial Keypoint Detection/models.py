...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        ## 1. This network takes in a square (same W and H), grayscale image as input
        ## 2. It ends with a linear layer that represents the keypoints
        ## it's suggested that you make this last layer output 136 values, 2 for each
        # of the 68 keypoint (x, y) pairs
        ...
        # fully conected layers,torch size
    ...
    def forward(self, x):
        ...
        ## x is the input image(here you may choose to include a pool/conv step):
